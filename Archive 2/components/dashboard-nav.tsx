...
import { BarChart3, Building2, CheckCircle, FileText, Home, Settings, Users, Target, DatabaseIcon } from "lucide-react"
...
const navItems = [
  ...
  {
    title: "ผลลัพธ์ KPI",
    href: "/dashboard/kpi-results",
    icon: Target,
    roles: ["admin", "manager", "approver", "staff"],
  },
  {
    title: "Query Templates",
    href: "/dashboard/query-templates",
    icon: DatabaseIcon,
    roles: ["admin", "manager"],
  },
  {
