...
export async function GET() {
  try {
    console.log("API: Getting KPI stats")
    ...
    console.log("API: Session found for user:", session.user.username)
    ...
    try {
      ...
      console.log("API: Executing queries with params:", params.length ? params : "No params")
      ...
      console.log("API: KPI stats result:", result)
